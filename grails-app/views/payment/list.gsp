            ...
            <tbody>
                <g:each var="payment" in="${ paymentList }">
                    <tr data-url="${ g.createLink([controller:'payment', action:'show', params:[id: payment.id]])}">
                        ...
                        <td><a href="${ g.createLink([controller:'payment', action:'show', params:[id: payment.id]]) }"><button type="button" class="btn btn-primary btn-padding-y">Detalhes</button></a></td>
                    </tr>
                </g:each>
            </tbody>
        </table>
