    ...
    <body>
        <div class="container-fluid mt-3 ml-4">
            ...
            <div class="card-deck">
                ...
                <a href="${ g.createLink([controller:'payer', action:'create', params:[id: customer.id]]) }"><button class="btn btn-primary btn-padding-y">Criar pagador</button></a>
                <a href="${ g.createLink([controller:'payer', action:'list', params:[id: customer.id]]) }"><button class="btn btn-primary btn-padding-y">Meus pagadores</button></a>
            </div>
        </div>
